...
if ( function_exists('register_sidebars') )
	...
	register_sidebar(array('name'=>'Footer Mid Left','before_widget'=>'<div id="%1$s" class="widget %2$s">','after_widget'=>'</div>','before_title'=>'<h4><span>','after_title'=>'</span></h4>'));
	register_sidebar(array('name'=>'Footer Mid Right','before_widget'=>'<div id="%1$s" class="widget %2$s">','after_widget'=>'</div>','before_title'=>'<h4><span>','after_title'=>'</span></h4>'));
...
add_image_size( 'home-feature', 960, 410, true ); // Slider Image
add_image_size( 'home-thumbnail', 630, 480, true ); // Homepage Thumbnail
add_image_size( 'home-teaser', 280, 160, true ); // Slider Image
add_image_size( 'page-feature', 940, 440, true ); // Featured page Banner
add_image_size( 'portfolio', 280, 320 ); // Portfolio Image
?>